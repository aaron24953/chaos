...
class StaffCreateBookingPage(object):
    ...
    def setupUI(self):
        ...
        self.customerIDButton = QtWidgets.QPushButton(self.Dialog)
        ...
        self.customerNameButton = QtWidgets.QPushButton(self.Dialog)
        ...
        self.customerFirstnameBox = QtWidgets.QLineEdit(self.Dialog)
        ...
        self.customerSurnameBox = QtWidgets.QLineEdit(self.Dialog)
